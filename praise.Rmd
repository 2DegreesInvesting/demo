...
The [praise package](https://github.com/rladies/praise) makes you and others feel good.
...
1. [Fork (owner/repo) and clone (your/repo)](https://happygitwithr.com/fork-and-clone.html).
...
8. [Add the upstream remote](https://happygitwithr.com/upstream-changes.html#upstream-changes).
